...
tmux bind-key "$create_key" display-popup -E -w 90% -h 90% "$CURRENT_DIR/scripts/create-worktree.sh"
tmux bind-key "$quick_create_key" display-popup -E -w 90% -h 90% "$CURRENT_DIR/scripts/create-worktree.sh --quick"
tmux bind-key "$kill_key" display-popup -E -w 90% -h 90% "$CURRENT_DIR/scripts/kill-worktree.sh"
